...
// This migration was compiled from migrations/postgres/20200819054742_trade_index.sql.
// The SQL statements are registered as data so they can be previewed in the
// console while the migration runs, exactly like a raw .sql migration.
func init() {
	AddStatementMigration("main", 20200819054742, "migrations/postgres/20200819054742_trade_index.sql", false,
