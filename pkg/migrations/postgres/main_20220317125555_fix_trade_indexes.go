...
// This migration was compiled from migrations/postgres/20220317125555_fix_trade_indexes.sql.
// The SQL statements are registered as data so they can be previewed in the
// console while the migration runs, exactly like a raw .sql migration.
func init() {
	AddStatementMigration("main", 20220317125555, "migrations/postgres/20220317125555_fix_trade_indexes.sql", true,
