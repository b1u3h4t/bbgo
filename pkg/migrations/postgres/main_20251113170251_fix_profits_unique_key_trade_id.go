...
// This migration was compiled from migrations/postgres/20251113170251_fix_profits_unique_key_trade_id.sql.
// The SQL statements are registered as data so they can be previewed in the
// console while the migration runs, exactly like a raw .sql migration.
func init() {
	AddStatementMigration("main", 20251113170251, "migrations/postgres/20251113170251_fix_profits_unique_key_trade_id.sql", true,
