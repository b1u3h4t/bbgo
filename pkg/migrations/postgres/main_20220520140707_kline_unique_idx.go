...
// This migration was compiled from migrations/postgres/20220520140707_kline_unique_idx.sql.
// The SQL statements are registered as data so they can be previewed in the
// console while the migration runs, exactly like a raw .sql migration.
func init() {
	AddStatementMigration("main", 20220520140707, "migrations/postgres/20220520140707_kline_unique_idx.sql", true,
