...
// This migration was compiled from migrations/postgres/20210215203111_add_pnl_column.sql.
// The SQL statements are registered as data so they can be previewed in the
// console while the migration runs, exactly like a raw .sql migration.
func init() {
	AddStatementMigration("main", 20210215203111, "migrations/postgres/20210215203111_add_pnl_column.sql", true,
