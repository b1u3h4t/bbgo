...
// This migration was compiled from migrations/postgres/20210223080622_add_rewards_table.sql.
// The SQL statements are registered as data so they can be previewed in the
// console while the migration runs, exactly like a raw .sql migration.
func init() {
	AddStatementMigration("main", 20210223080622, "migrations/postgres/20210223080622_add_rewards_table.sql", false,
