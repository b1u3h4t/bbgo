...
// This migration was compiled from migrations/postgres/20211205162302_add_is_futures_column.sql.
// The SQL statements are registered as data so they can be previewed in the
// console while the migration runs, exactly like a raw .sql migration.
func init() {
	AddStatementMigration("main", 20211205162302, "migrations/postgres/20211205162302_add_is_futures_column.sql", true,
