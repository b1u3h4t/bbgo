...
// This migration was compiled from pkg/strategy/xfundingv2/migrations/postgres/20260713211916_add_unique_key_round_id.sql.
// The SQL statements are registered as data so they can be previewed in the
// console while the migration runs, exactly like a raw .sql migration.
func init() {
	AddStatementMigration("xfundingv2", 20260713211916, "pkg/strategy/xfundingv2/migrations/postgres/20260713211916_add_unique_key_round_id.sql", true,
