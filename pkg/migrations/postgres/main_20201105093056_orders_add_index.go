...
// This migration was compiled from migrations/postgres/20201105093056_orders_add_index.sql.
// The SQL statements are registered as data so they can be previewed in the
// console while the migration runs, exactly like a raw .sql migration.
func init() {
	AddStatementMigration("main", 20201105093056, "migrations/postgres/20201105093056_orders_add_index.sql", true,
