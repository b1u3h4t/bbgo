...
// This migration was compiled from migrations/postgres/20210307201830_add_deposits_table.sql.
// The SQL statements are registered as data so they can be previewed in the
// console while the migration runs, exactly like a raw .sql migration.
func init() {
	AddStatementMigration("main", 20210307201830, "migrations/postgres/20210307201830_add_deposits_table.sql", false,
