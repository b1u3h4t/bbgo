...
// This migration was compiled from migrations/postgres/20210119232826_add_margin_columns.sql.
// The SQL statements are registered as data so they can be previewed in the
// console while the migration runs, exactly like a raw .sql migration.
func init() {
	AddStatementMigration("main", 20210119232826, "migrations/postgres/20210119232826_add_margin_columns.sql", true,
