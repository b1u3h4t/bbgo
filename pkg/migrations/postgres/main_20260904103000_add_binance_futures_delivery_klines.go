...
// This migration was compiled from migrations/postgres/20260904103000_add_binance_futures_delivery_klines.sql.
// The SQL statements are registered as data so they can be previewed in the
// console while the migration runs, exactly like a raw .sql migration.
func init() {
	AddStatementMigration("main", 20260904103000, "migrations/postgres/20260904103000_add_binance_futures_delivery_klines.sql", false,
