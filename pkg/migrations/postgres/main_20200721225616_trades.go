...
// This migration was compiled from migrations/postgres/20200721225616_trades.sql.
// The SQL statements are registered as data so they can be previewed in the
// console while the migration runs, exactly like a raw .sql migration.
func init() {
	AddStatementMigration("main", 20200721225616, "migrations/postgres/20200721225616_trades.sql", false,
