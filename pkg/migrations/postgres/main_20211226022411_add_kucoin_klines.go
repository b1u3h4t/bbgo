...
// This migration was compiled from migrations/postgres/20211226022411_add_kucoin_klines.sql.
// The SQL statements are registered as data so they can be previewed in the
// console while the migration runs, exactly like a raw .sql migration.
func init() {
	AddStatementMigration("main", 20211226022411, "migrations/postgres/20211226022411_add_kucoin_klines.sql", false,
