...
// This migration was compiled from migrations/postgres/20260716093831_add_funding_fees.sql.
// The SQL statements are registered as data so they can be previewed in the
// console while the migration runs, exactly like a raw .sql migration.
func init() {
	AddStatementMigration("main", 20260716093831, "migrations/postgres/20260716093831_add_funding_fees.sql", true,
