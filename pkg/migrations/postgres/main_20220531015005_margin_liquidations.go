...
// This migration was compiled from migrations/postgres/20220531015005_margin_liquidations.sql.
// The SQL statements are registered as data so they can be previewed in the
// console while the migration runs, exactly like a raw .sql migration.
func init() {
	AddStatementMigration("main", 20220531015005, "migrations/postgres/20220531015005_margin_liquidations.sql", false,
