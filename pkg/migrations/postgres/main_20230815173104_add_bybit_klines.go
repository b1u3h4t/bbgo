...
// This migration was compiled from migrations/postgres/20230815173104_add_bybit_klines.sql.
// The SQL statements are registered as data so they can be previewed in the
// console while the migration runs, exactly like a raw .sql migration.
func init() {
	AddStatementMigration("main", 20230815173104, "migrations/postgres/20230815173104_add_bybit_klines.sql", false,
