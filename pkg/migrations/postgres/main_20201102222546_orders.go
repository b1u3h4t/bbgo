...
// This migration was compiled from migrations/postgres/20201102222546_orders.sql.
// The SQL statements are registered as data so they can be previewed in the
// console while the migration runs, exactly like a raw .sql migration.
func init() {
	AddStatementMigration("main", 20201102222546, "migrations/postgres/20201102222546_orders.sql", false,
