...
// This migration was compiled from migrations/postgres/20210531234123_add_kline_taker_buy_columns.sql.
// The SQL statements are registered as data so they can be previewed in the
// console while the migration runs, exactly like a raw .sql migration.
func init() {
	AddStatementMigration("main", 20210531234123, "migrations/postgres/20210531234123_add_kline_taker_buy_columns.sql", true,
