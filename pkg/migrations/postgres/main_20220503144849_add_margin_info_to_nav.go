...
// This migration was compiled from migrations/postgres/20220503144849_add_margin_info_to_nav.sql.
// The SQL statements are registered as data so they can be previewed in the
// console while the migration runs, exactly like a raw .sql migration.
func init() {
	AddStatementMigration("main", 20220503144849, "migrations/postgres/20220503144849_add_margin_info_to_nav.sql", true,
