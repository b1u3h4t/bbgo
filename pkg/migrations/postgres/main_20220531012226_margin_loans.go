...
// This migration was compiled from migrations/postgres/20220531012226_margin_loans.sql.
// The SQL statements are registered as data so they can be previewed in the
// console while the migration runs, exactly like a raw .sql migration.
func init() {
	AddStatementMigration("main", 20220531012226, "migrations/postgres/20220531012226_margin_loans.sql", false,
